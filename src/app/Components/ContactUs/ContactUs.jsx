...
import { Send, CheckCircle2, AlertCircle, Calendar, Code2, Palette, Globe2 } from "lucide-react"
    ...
    >
      <div className="space-y-8 relative z-10">
        ...
        >
          ...
          <div>
            <h3 className="text-white font-semibold text-lg">Design Excellence</h3>
            <p className="text-gray-400">Crafting visually stunning experiences</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div>
            <h3 className="text-white font-semibold text-lg">Development Mastery</h3>
        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
          ...
          >
            ...
            >
              ...
              <p className="text-gray-400 text-lg mb-8">Transform your ideas into reality with our expertise</p>
            </motion.div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent className="bg-[#232323] text-white border-[#4646ff]/20">
                        <SelectItem value="general" className= "cursor-pointer hover:font-extrabold">General Inquiry</SelectItem>
                        <SelectItem value="support" className= "cursor-pointer hover:font-extrabold">Technical Support</SelectItem>
                        <SelectItem value="billing" className= "cursor-pointer hover:font-extrabold">Billing Question</SelectItem>
                        <SelectItem value="partnership" className= "cursor-pointer hover:font-extrabold">Partnership Opportunity</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="space-y-2">
            ...
            <div className="grid gap-2 text-sm">
              <motion.p className="flex items-center space-x-2 text-gray-400" whileHover={{ x: 5 }}>
