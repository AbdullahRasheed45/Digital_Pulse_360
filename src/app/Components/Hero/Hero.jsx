  ...
  return (
    ...
    <div className="relative top-[5rem] w-full h-[50vh] sm:h-[80vh] lg:h-[100vh] xl:h-[110vh] bg-[#1C1D21] sm:z-0s">
      ...
      <div className="m-0 p-0 relative flex items-center justify-start w-1/2">
        <img className="sm:absolute sm:w-[250px] sm:left-[-60px] sm:top-[-50px] lg:w-[350px] xl:w-auto xl:left-[-50px] transform -rotate-45 sm:-z-10" src="images/iPad.png" alt="" />
        <img className="absolute sm:w-[200px] sm:left-[80px] lg:w-[250px] lg:left-[140px] xl:w-auto xl:left-[220px] transform -rotate-45 -z-10" src="images/mouse.png" alt="" />
      </div>
      <div className="m-0 p-0 relative flex items-center justify-start w-1/2">
        <img className="absolute sm:w-[150px] lg:w-[250px] xl:w-auto right-[-20px] top-[-30vh]" src="images/Planctonic.png" alt="" />
        <img className="absolute sm:w-[200px] sm:top-[-100px] sm:right-[30px] lg:w-[250px] lg:right-[7vw] lg:top-[-30px] xl:w-auto xl:top-[-60px] xl:right-[11vw]" src="images/Coffee-cup.png" alt="" />
        <img className="absolute sm:w-[200px] sm:top-[-50px] sm:right-[-20px] lg:w-[280px] lg:right-[-20px] lg:top-[20px] xl:w-auto transform scale-x-[-1] rotate-45 xl:right-[-20px] xl:top-[20px] -z-10" src="images/Apple-keyboards.png" alt="" />
      </div>
      </div>
