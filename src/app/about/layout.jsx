...
export const metadata = {
  ...
  description:
    "Learn about Digital Pulse 360's journey in digital innovation. Discover our story, meet our expert team, and explore our core values in web development, mobile apps, SEO, and digital marketing.",
  keywords: [
    "Digital Pulse 360",
    "digital agency",
    "about us",
  ...
  openGraph: {
    title: "About Us | Digital Pulse 360 | Innovation Meets Excellence",
    description:
      "Meet the team behind Digital Pulse 360 and discover how we're transforming the digital landscape with innovative solutions and cutting-edge technology.",
  ...
  twitter: {
    ...
    description:
      "Discover our journey in digital innovation and meet the team shaping the future of digital transformation.",
  ...
  other: {
    "schema-org": {
      ...
      description:
        "A leading digital innovation agency specializing in web development, mobile apps, SEO, and digital marketing solutions.",
      foundingDate: "2020",
      founders: [
        {
          "@type": "Person",
